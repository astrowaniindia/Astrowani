    ...
    <ScrollView style={styles.main} contentContainerStyle={styles.content}>
      ...
      <TouchableOpacity
        ...
        {submitting ? (
          ...
          <Text style={styles.buttonText}>Get Dosh Report{service ? ` — ₹${service.price}` : ''}</Text>
        )}
      </TouchableOpacity>
    </ScrollView>
  );
