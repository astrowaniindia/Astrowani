...
export default class EnxVideoView extends PureComponent<Props, State> {
  ...
  async requestPermission() {
    // Permission handled in UNSAFE_componentWillMount now
  }
  ...
  _onPressMute = () => {
    ...
    this.setState({
      audioMuteUnmuteCheck: !this.state.audioMuteUnmuteCheck,
      audioMuteUnmuteImage: this.state.audioMuteUnmuteCheck ? require('../image_asset/mute.png') : require('../image_asset/unmute.png'),
    });
  };
  ...
  _onPressVideoMute = () => {
    ...
    this.setState({
      videoMuteUnmuteCheck: !this.state.videoMuteUnmuteCheck,
      videoMuteUnmuteImage: this.state.videoMuteUnmuteCheck ? require('../image_asset/stopvideo.png') : require('../image_asset/startvideo.png'),
    });
  };
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#1A0B05', // very dark brown
