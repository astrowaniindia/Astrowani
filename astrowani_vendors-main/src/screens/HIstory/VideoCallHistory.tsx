...
const VideoCallHistory = ({ navigation }: any) => {
  ...
  const getHistory = async () => {
    ...
    try {
      ...
      console.log("Error fetching video history: ", error);
      setLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={!loading ? <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 50 }}><Text>No video call history found</Text></View> : null}
        />
      }
    </View>
  );
